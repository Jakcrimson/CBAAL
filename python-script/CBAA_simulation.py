...
from CBAA_agent import CBAA_agent
...
def save_plot_gif(phase, ax, save_gif, plot_gap, fig, filenames, t):
...
def simulation(task_num, agent_num, max_t, save_gif, topology):
    ...
    while True:
        ...
        ## Save plot for gif
        save_plot_gif("Auction", ax, save_gif, plot_gap, fig, filenames, t)
        ...
        ## Save plot for gif
        save_plot_gif("Consensus", ax, save_gif, plot_gap, fig, filenames, t)
